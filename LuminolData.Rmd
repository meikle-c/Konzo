...
for (sex in unique_sex) {
  ...
  PlotbySex <- ggplot(df, aes(x = Sample_Type, y = RFU)) +
    geom_boxplot() +
    stat_compare_means(method = "t.test") +
...
```
The p-values when controlling for the relative size of the Konzo/Control populations by subsampling is still signficant. 
